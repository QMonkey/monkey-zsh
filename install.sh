...
readonly INSTALL_DIR="${INSTALL_DIR:-$HOME/Documents/monkey-zsh}"
readonly SUDOERS_D_DIR="${SUDOERS_D_DIR:-/etc/sudoers.d}"
SUDO_NOPASSWD=0
readonly NOPASSWD_DROPIN="$SUDOERS_D_DIR/zz-monkey-zsh-nopasswd"
...
readonly ACQUIRE_TIOCSTI="${ACQUIRE_TIOCSTI:-monkey-zsh}"
